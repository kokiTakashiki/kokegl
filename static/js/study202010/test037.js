...
function kokeModel2(baseLocation, random){
	...
	kokegeo.vertices.push(new THREE.Vector3(0*cosAM+p.x, vmhight, 0*sinAM+p.y));//1
	kokegeo.vertices.push(new THREE.Vector3(0*cosAT+p.x, vthight, -0.2*sinAT+p.y));//2
	//koke1
	kokegeo.vertices.push(new THREE.Vector3(1*cosAF+p.x, 0, 0*sinAF+p.y));//3
	kokegeo.vertices.push(new THREE.Vector3(1*cosAM+p.x, vmhight, 0*sinAM+p.y));//4
	kokegeo.vertices.push(new THREE.Vector3(0.5*cosAT+p.x, vthight, -0.9*sinAT+p.y));//5
	//koke2
	kokegeo.vertices.push(new THREE.Vector3(-0.5*cosAF+p.x, 0, 0.9*sinAF+p.y));//6
	kokegeo.vertices.push(new THREE.Vector3(-0.5*cosAM+p.x, vmhight, 0.9*sinAM+p.y));//7
	kokegeo.vertices.push(new THREE.Vector3(0.5*cosAT+p.x, vthight, 0.9*sinAT+p.y));//8
	//koke3
	kokegeo.vertices.push(new THREE.Vector3(-0.5*cosAF+p.x, 0, -0.9*sinAF+p.y));//9
	kokegeo.vertices.push(new THREE.Vector3(-0.5*cosAM+p.x, vmhight, -0.9*sinAM+p.y));//10
	kokegeo.vertices.push(new THREE.Vector3(-1*cosAT+p.x, vthight, 0*sinAT+p.y));//11
	...
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(1.0, 0.0),new THREE.Vector2(1.0, 0.5),new THREE.Vector2(0.5, 0.0)
	]);
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.5, 0.0),new THREE.Vector2(1.0, 0.5),new THREE.Vector2(0.5, 0.5)
	]);
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.5, 0.5),new THREE.Vector2(1.0, 0.5),new THREE.Vector2(1.0, 1.0)
	]);
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(1.0, 1.0),new THREE.Vector2(0.5, 1.0),new THREE.Vector2(0.5, 0.5)
	]);

	//koke2
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.5, 0.0),new THREE.Vector2(0.0, 0.0),new THREE.Vector2(0.5, 0.0)
	]);
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.0, 0.5),new THREE.Vector2(0.5, 0.0),new THREE.Vector2(0.5, 0.5)
	]);
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.0, 1.0),new THREE.Vector2(0.0, 0.5),new THREE.Vector2(0.5, 0.5)
	]);
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.0, 1.0),new THREE.Vector2(0.5, 0.5),new THREE.Vector2(0.5, 1.0)
	]);
