...
function kokeModel2(baseLocation, random){
	...
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(1.0, 0.0),new THREE.Vector2(1.0, 0.5),new THREE.Vector2(0.0, 0.0)
	]);

	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.0, 0.5),new THREE.Vector2(0.0, 0.0),new THREE.Vector2(1.0, 0.5)
	]);

	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(1.0, 0.5),new THREE.Vector2(1.0, 1.0),new THREE.Vector2(0.0, 0.5)
	]);

	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.0, 1.0),new THREE.Vector2(0.0, 0.5),new THREE.Vector2(1.0, 1.0)
	]);
...
function kokeModel3(baseLocation, random){
	...
	kokegeo.vertices.push(new THREE.Vector3(-1*cosAM+p.x, hight, 1*sinAM+p.y));//1
	kokegeo.vertices.push(new THREE.Vector3(1*cosAM+p.x, hight, -1*sinAM+p.y));//2
	kokegeo.vertices.push(new THREE.Vector3(-1*cosAM+p.x, hight, -1*sinAM+p.y));//3
	...
	kokegeo.faceVertexUvs[0].push([
		new THREE.Vector2(0.0, 1.0),new THREE.Vector2(0.0, 0.0),new THREE.Vector2(1.0, 1.0)
	]);
