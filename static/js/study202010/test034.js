...
renderer = new THREE.WebGLRenderer({canvas: document.querySelector("#test034Canvas")});
...
function init(){
	...
	//koke2
	geometry.faceVertexUvs[0].push([
		new THREE.Vector2(0.5, 0.0),new THREE.Vector2(0.5, 0.5),new THREE.Vector2(0.0, 0.0)
	]);
	geometry.faceVertexUvs[0].push([
		new THREE.Vector2(0.0, 0.0),new THREE.Vector2(0.5, 0.5),new THREE.Vector2(0.0, 0.5)
	]);
	geometry.faceVertexUvs[0].push([
		new THREE.Vector2(0.5, 0.5),new THREE.Vector2(0.5, 1.0),new THREE.Vector2(0.0, 0.5)
	]);
	geometry.faceVertexUvs[0].push([
		new THREE.Vector2(0.0, 0.5),new THREE.Vector2(0.5, 1.0),new THREE.Vector2(0.0, 1.0)
	]);
