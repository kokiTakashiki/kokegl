...
function kokeModel(baseLocation){
	...
	kokegeo.vertices.push(new THREE.Vector3(-1+baseLocation.x, 0+baseLocation.y, 0.5+baseLocation.z));
	//mid
	kokegeo.vertices.push(new THREE.Vector3(1+baseLocation.x, 1.8+baseLocation.y, 0.5+baseLocation.z));
	kokegeo.vertices.push(new THREE.Vector3(-1+baseLocation.x, 1.8+baseLocation.y, 1.5+baseLocation.z));
	//top
	kokegeo.vertices.push(new THREE.Vector3(1+baseLocation.x, 3.5+baseLocation.y, 2.5+baseLocation.z));
	kokegeo.vertices.push(new THREE.Vector3(-1+baseLocation.x, 3.5+baseLocation.y, 2+baseLocation.z));
