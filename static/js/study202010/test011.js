...
function kokeModel(baseLocation, random){
	...
	// 頂点
	//base
	kokegeo.vertices.push(new THREE.Vector3(0.5+baseLocation.x+random, 0+baseLocation.y, 0+baseLocation.z));
	kokegeo.vertices.push(new THREE.Vector3(-0.5+baseLocation.x+random, 0+baseLocation.y, 0.5+baseLocation.z));
	//mid
	kokegeo.vertices.push(new THREE.Vector3(0.5+baseLocation.x+random, 1.8+baseLocation.y, -1.5+baseLocation.z+random));
	kokegeo.vertices.push(new THREE.Vector3(-0.5+baseLocation.x+random, 1.8+baseLocation.y, -0.5+baseLocation.z+random));
	//top
	kokegeo.vertices.push(new THREE.Vector3(0.5+baseLocation.x+random, 3.5+baseLocation.y, -1.5+baseLocation.z+random));
	kokegeo.vertices.push(new THREE.Vector3(-0.5+baseLocation.x+random, 3.5+baseLocation.y, -2+baseLocation.z+random));
