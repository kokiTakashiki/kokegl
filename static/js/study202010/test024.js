...
function kokeModel2(baseLocation, random){
	...
	kokegeo.vertices.push(new THREE.Vector3((-v2d*Math.cos(angle))+p.x, 0.0, (-v2d*Math.sin(angle))+p.y));
	//mid
	kokegeo.vertices.push(new THREE.Vector3(cosAM.x+p.x, vmhight, sinAM.x+p.y+1.8));
	kokegeo.vertices.push(new THREE.Vector3(cosAM.y+p.x, vmhight, sinAM.y+p.y+1.0));
	//top
	kokegeo.vertices.push(new THREE.Vector3(cosAT.x+p.x, vthight, sinAT.x+p.y+3.0));
	kokegeo.vertices.push(new THREE.Vector3(cosAT.y+p.x, vthight, sinAT.y+p.y+3.5));
