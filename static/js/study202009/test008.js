...
function kokeModel(baseLocation){
	...
	//mid
	kokegeo.vertices.push(new THREE.Vector3(1+baseLocation.x, 2+baseLocation.y, -0.5+baseLocation.z));
	kokegeo.vertices.push(new THREE.Vector3(-1+baseLocation.x, 2+baseLocation.y, 0.5+baseLocation.z));
	//top
	kokegeo.vertices.push(new THREE.Vector3(1+baseLocation.x, 4+baseLocation.y, 0.5+baseLocation.z));
